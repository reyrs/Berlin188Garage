...
import { resetStaffPassword } from '@shared/auth';
...
export default function LoginModal({ variant = 'page' }: LoginModalProps) {
  const { login, activeStaffUser } = useAuthStore();
