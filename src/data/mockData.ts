import { Order, User, CashTransaction, CashClosing, WarehouseStockItem, Expense } from '../types';

export const INITIAL_USERS: User[] = [
  {
    id: 'owner-1',
    name: 'Owner Berlin 188',
    role: 'owner',
    email: 'owner@berlin188.com',
    phone: '081234567890',
